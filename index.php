				...
				<div class="about_item">
					<div class="about_inner">
						...
						<div class="about_text">
							Впервые в Казахстане "Казахско-турецкие" лицеи открылысь в 1992 году,
							под согласием президентов двух стран, Казахстана и Турции, в городах
							Туркистан и Кокшетау. А в нашем городе он был	 открыт в 1993 году.
							Среднее количество баллов на ЕНТ за последние 10 лет - 104.5.
							В 2017 году название лицея поменялась на "Білім-инновация" лицей.
						</div>
					</div>
				</div>
			</div>
			...
			<div class="advantage_content">
				<div class="advantage_item">
					...
					<div class="advantage_block">
						...
						<div class="advantage_all_post">
							...
							<div class="advantage_post_text">
								Наша школа ценит не только знание, но и воспитание. И в этом заслуга
								наших воспитателей.
							</div>
						</div>
					</div>
				...
				<div class="advantage_item">
					<div class="advantage_block">
						...
						<div class="advantage_all_post">
							<div class="advantage_post_title">
								Обучение на разнах языках
							</div>
							<div class="advantage_post_text">
								Одним из преимуществ нашего лицея - это обучение основных предметов на
								английском языке.
							</div>
						</div>
					</div>
					<div class="advantage_block">
						...
						<div class="advantage_all_post">
							...
							<div class="advantage_post_text">
								Ученики нашего лицея занимают первые места по предметным олимпиадам.
							</div>
						</div>
					</div>
					<div class="advantage_block">
						...
						<div class="advantage_all_post">
							...
							<div class="advantage_post_text">
								Так же у нас имеется условие для проживание в общежитии. Проживание в нем
